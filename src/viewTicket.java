...
public class viewTicket extends javax.swing.JFrame {
        ...
        groupLayoutPanel2.setHorizontalGroup(
                groupLayoutPanel2.createParallelGroup(Alignment.TRAILING)
                        .addGroup(groupLayoutPanel2.createSequentialGroup()
                                ...
                                .addComponent(viewTicketLabel, GroupLayout.PREFERRED_SIZE, 260,
        ...
        groupLayoutPanel7.setHorizontalGroup(
                groupLayoutPanel7.createParallelGroup(Alignment.LEADING)
                        .addGroup(groupLayoutPanel7.createSequentialGroup()
                                .addGap(19)
                                .addGroup(groupLayoutPanel7.createParallelGroup(Alignment.LEADING)
                                        .addGroup(groupLayoutPanel7.createSequentialGroup()
                                                .addComponent(numberLabel)
                                                .addPreferredGap(ComponentPlacement.RELATED, 597, Short.MAX_VALUE))
                                        .addGroup(groupLayoutPanel7.createSequentialGroup()
                                                .addComponent(contactUsLabel, GroupLayout.DEFAULT_SIZE, 581,
                                                        Short.MAX_VALUE)
                                                .addGap(90)))
                                .addGroup(groupLayoutPanel7.createParallelGroup(Alignment.TRAILING)
                                        .addGroup(groupLayoutPanel7.createSequentialGroup()
        ...
        groupLayoutPanel1.setHorizontalGroup(
                groupLayoutPanel1.createParallelGroup(Alignment.LEADING)
                        ...
                        .addGroup(groupLayoutPanel1.createSequentialGroup()
                                .addGap(560)
                                .addComponent(instructionLabel, GroupLayout.PREFERRED_SIZE, 222,
                                        GroupLayout.PREFERRED_SIZE)
                                .addGap(18)
                                .addComponent(ticketText, GroupLayout.PREFERRED_SIZE, 132, GroupLayout.PREFERRED_SIZE)
                                .addContainerGap(608, Short.MAX_VALUE))
                        .addGroup(groupLayoutPanel1.createSequentialGroup()
                                .addGap(210)
                                .addComponent(backgroundAdjustLabel1, GroupLayout.PREFERRED_SIZE, 400,
                                        GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(ComponentPlacement.RELATED)
                ...
                groupLayoutPanel1.createParallelGroup(Alignment.LEADING)
                        .addGroup(groupLayoutPanel1.createSequentialGroup()
                                ...
                                .addGroup(groupLayoutPanel1.createParallelGroup(Alignment.BASELINE)
                                        ...
                                        .addComponent(ticketText, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
                                                GroupLayout.PREFERRED_SIZE))
                                        ...
                                        .addGroup(groupLayoutPanel1.createSequentialGroup()
                                                ...
                                                .addGroup(groupLayoutPanel1.createParallelGroup(Alignment.BASELINE)
                                                        .addComponent(backBtn, GroupLayout.PREFERRED_SIZE, 40,
                                                                GroupLayout.PREFERRED_SIZE)
                                                        .addComponent(proceedBtn, GroupLayout.PREFERRED_SIZE, 40,
                                                                GroupLayout.PREFERRED_SIZE))))
        ...
        layout.setHorizontalGroup(
                layout.createParallelGroup(Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addComponent(panel1, GroupLayout.PREFERRED_SIZE, 1542, GroupLayout.PREFERRED_SIZE)
     ...
     * @return None.
     */
    private void proceedBtnAction(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_proceedBtnAction
        Connection con;
